...
import com.csipsimple.db.MyDBAdapter;
import com.csipsimple.models.Filter;

/**
 * This adapter is used to filter contacts on both name and number.
 */
public class ContacksSearchGridAdapter extends CursorAdapter implements SectionIndexer {

//    private static final String TAG = "ContacksSearchGridAdapter";
...
//    private List<View> listItemView = new ArrayList<View>();
    
    public ContacksSearchGridAdapter(Context context) {
        ...
        super(context,new MyDBAdapter(context).getSortedContact()/*  ContactsWrapper.getInstance().getContactsPhones(context,"")*/, false /* no auto-requery */);               
        mContext = context;
...
//        {
//        	if (view == listItemView.get(i)){
//        		isAdd = false;
//        		break;
//        	}
//        }
//        if (isAdd){
//        	listItemView.add(view);
//        	curIndex ++;
//        }
//        
//        Log.d(TAG,"curIndex:"+curIndex+",name "+ cursor.getString(cursor.getColumnIndex(Data.DISPLAY_NAME)));
//        if (curIndex == cursor.getCount()){
//        	resortGridView();
//        }
//        
//        /* 重新绑定 */
...
//    		ContactsWrapper.getInstance().bindContactPhoneView(listItemView.get(i), mContext, c);
//    	}
//		c.close();
//    }
    
//    public String getSelectNumber(int index){
//    	String num =((TextView)listItemView.get(index).findViewById(R.id.number)).getText().toString();
//    	return num;
//    }
    @Override
