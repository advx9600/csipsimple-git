...
public class ActionMenuView extends IcsLinearLayout implements
	...
	private boolean mIsSetVerticalLayout = false;
	...
	public void setVerticalLayout(boolean isSetVertical) {
		mIsSetVerticalLayout = isSetVertical;
	}
	...
	protected void onLayout(boolean changed, int left, int top, int right,
			int bottom) {
		if (!mFormatItems && !mIsSetVerticalLayout) {
		...
		int heightRemaining = bottom - top - getPaddingBottom();
